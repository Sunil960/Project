...
<body class="navbar-top">
	...
	<div class="navbar navbar-expand-md navbar-dark fixed-top">
		...
		<div class="collapse navbar-collapse" id="navbar-mobile">
			...
			<span class="badge bg-success ml-md-3 mr-md-auto">Server Online</span>
			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item {{(Request::segment(1) == 'start') ? 'nav-item-open' : '' }}">
							<a href="{{url('/start')}}" class="nav-link">
								<i class="icon-home4"></i>
								<span>Start</span>
							</a>
						</li>
						<li class="nav-item {{(Request::segment(1) == 'account') ? 'nav-item-open' : '' }}">
							<a href="{{url('/account')}}" class="nav-link"><i class="icon-pencil3"></i> <span>My Account</span></a>
						</li>
